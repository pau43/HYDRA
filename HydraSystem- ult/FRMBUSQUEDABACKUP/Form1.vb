...
Public Class Form1
    ...
    Dim UserCrea As String = "anthonyva"
    ...
    Private Sub pdu_listadoPadron()
        Try
            dtPersonasPred = WFControlRAda.Instancia.fdu_Rada_PadronxCampaña(cboCampana.SelectedValue.ToString)
    ...
    Public Sub predios_x_IdPersona(ByVal campaña As String, ByVal identidad As String)
        ...
        Try
            dt = WFControlRAda.Instancia.fdu_Predio_x_Id(identidad, campaña)
            With dgvPredios
                .DataSource = dt
                For Each col As DataGridViewColumn In .Columns
                    col.Visible = True
