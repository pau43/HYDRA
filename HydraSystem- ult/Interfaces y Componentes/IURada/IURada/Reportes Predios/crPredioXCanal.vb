...
Public Class crPredioXCanal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IURada.crPredioXCanal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPredioXCanal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPredioXCanal = New crPredioXCanal()
        rpt.Site = Me.Site
        Return rpt
    End Function
